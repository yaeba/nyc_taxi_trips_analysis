...
trips_data %>%
  ...
  ggplot() +
  geom_point(aes(x=Average_temp, y=Num_trips, color=Season)) +
  geom_smooth(aes(x=Average_temp, y=Num_trips, color=Season, fill=Season), method=lm)
...
```{r tipping}
# Find ratio of tipping to the total amount paid by passenger
trips_data %>%
